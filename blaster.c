/**
 * A User Datagram Protocol (UDP) implementation
 * blaster.c / client
 *
 ...
 *
 * blaster is invoked as such:
 * blaster -s <hostname> -p <port_num> -r <rate> -n <num_pkts> -q <seq_num> -l <length> -c <echo>
 *
 */
...
int main(int argc, char *argv[]) {
    ...
    //for (k= 0; k < span; k++) { datagram[9+k]= msg[k]; }
